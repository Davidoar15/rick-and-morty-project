            ...
            <div className={style.firstRow}>
                ...
                <div className={style.descriptions}>
                    <div className={style.description}>
                        <h3 className={style.descriptionH3}>David Olivo. Perfil (Español)</h3>
                        <p className={style.pAbout}>
                            Joven venezolano de 21 años, residiendo en Argentina, con buena capacidad para la adaptación 
                            y el aprendizaje. Interesado en la adquisición de nuevos conocimientos. Aficionado a los
                            videojuegos y las tecnologías. Gusta de analizar minuciosamente las diferentes situaciones.</p>
                    </div>

                    <div className={style.description}>
                        <h3 className={style.descriptionH3}>David Olivo. Profile (English)</h3>
                        <p className={style.pAbout}>
                            21 years old young venezuelan, living in Argentina, with good capacity to adapt and learn. 
                            Very interested in acquire new knowledge. Fan of videogames and tecnologies. Like to analize
